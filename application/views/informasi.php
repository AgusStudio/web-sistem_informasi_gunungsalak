            ...
            <div class="row featurette">
              <div class="col-md-12">  
                ...
                <div class="box-body">
                  ...
                  <p style="text-align: justify; text-indent: 0.5in;"><?php echo $limited_string = $this->Model_halimun->limit_words($info->isi_info, 30);?>...<a href="<?php echo base_url('welcome/detail_informasi/'.$info->id_info.'/'.$info->kategori.'/'.$info->judul_info);?>"> Read More</a></p>
                </div>
              </div>
            </div>
            <hr>
