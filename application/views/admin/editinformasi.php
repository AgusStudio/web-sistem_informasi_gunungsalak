                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                           <?php echo form_open_multipart('admin/edit_informasi');?>
                                                ...
                                                <div class="form-group">
                                                    <input value= '<?php echo $informasi_edit->judul_info;?>' name="judul" type="text" placeholder="Judul informasi" class="form-control" required />
                                                     <input value= '<?php echo $informasi_edit->id_info;?>' name="id_info" type="text" hidden="hidden"/>
                                                </div>   
                                                <div class="form-group text-center">
                                                    <img name="image" src= '<?php echo base_url('assets/img/info/'.$informasi_edit->gambar_info);?>' class="img-thumbnail" id="preview" src="" alt="Image"/>
                                                </div>  
                                                <div class='form-group'>
                                                    <textarea name='isi' class='wysihtml5 form-control' style='height: 200px'><?php echo $informasi_edit->isi_info;?></textarea>
                                                </div> 
                                                <div class="form-group"> 
