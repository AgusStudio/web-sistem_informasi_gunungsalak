System.registerDynamic("moment", [], false, function (__require, __exports, __module) {
  ...
  (function () {
    ...
    (function (global, factory) {
      ...
      var defaultLocaleWeekdaysShort = 'Min_Sen_Sel_Rab_Kam_Jum_Sab'.split('_');
      function localeWeekdaysShort(m) {
        return this._weekdaysShort[m.day()];
      }
      var defaultLocaleWeekdaysMin = 'Mi_Sn_Se_Ra_Ka_Ju_Sa'.split('_');
    ...
    execute: function () {
      ...
      DatePicker = (function () {
        ...
        DatePicker.prototype.selectDate = function (e, date) {
          ...
          } else if (date.month < 1) { // Go to previous year
            date.year -= 1;
            date.month = 12;
          }
        ...
        DatePicker.prototype.generateCalendar = function (date) {
          var dateFrom = new moment(date).subtract(1, 'months').endOf('month').date();
          ...
          remainingDay = totalDay - lastDayOfMonth - (firstWeekDay - 1);
          // console.log(totalDay);
          // console.log(lastDayOfMonth);
          // console.log(remainingDay);
          for (var i = n; i <= lastDayOfMonth + remainingDay; i += 1) {
            if (i > 0) {
              var ii = i;
              var mm = month + 1;
              var year = year;
        ...
        DatePicker.prototype.setValue = function (value) {
          ...
          this.viewValue = val.format(this.viewFormat || 'D MMMM YYYY');
